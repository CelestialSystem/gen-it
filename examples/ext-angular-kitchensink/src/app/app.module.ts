...
import { GridFilterbarService }                   from '../examples/grids/add_ons/GridFilterbar/GridFilterbar.service'
...
import {TreeGroupedGridComponent}          from '../examples/grids/add_ons/TreeGroupedGrid/TreeGroupedGrid';
...
import {GridFilterbarComponent}            from '../examples/grids/add_ons/GridFilterbar/GridFilterbar';
    ...
    { text: 'Grids', navIcon: 'icon-grids', children: [
      ...
      { text: 'Add-ons', navIcon: 'icon-framing-buttons', children: [
        { text: 'Tree Grouped Grid', component: TreeGroupedGridComponent, navIcon: 'icon-tree-grouped-grid' },
          ...
          { text: 'Grid Filterbar', component: GridFilterbarComponent, navIcon: 'icon-grid-filtering'},
...
var theroutes =[
    ...
    { path: 'grids/addons/tree_grouped_grid', component: TreeGroupedGridComponent, text: 'Tree Grouped Grid', iconCls: 'x-fa fa-calendar', xtype: 'homeview', leaf: true },
    ...
    { path: 'grids/addons/grid_filterbar', component: GridFilterbarComponent, text: 'Grid Filterbar', iconCls: 'x-fa fa-calendar', xtype: 'homeview', leaf: true },
